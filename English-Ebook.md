...
1. [持续集成（第二版）](http://article.yeeyan.org/view/2251/94882) (译言网)
...
1. [PHP调试技术手册](http://www.laruence.com/2010/06/21/1608.html)(PDF)
...
7. [Laravel4 中文文档](http://www.golaravel.com/docs/)
8. [Symfony2中文文档](http://symfony-docs-chs.readthedocs.org/en/latest/) (未译完)
...
2. [Rails 风格指南](https://github.com/JuanitoFatas/rails-style-guide/blob/master/README-zhCN.md)
3. [Ruby on Rails Tutorial 原书第 2 版](http://railstutorial-china.org/) (本书网页版免费提供，电子版以 PDF、EPub 和 Mobi 格式提供购买，仅售 9.9 美元)
...
1. [ANSI Common Lisp 中文翻譯版](http://acl.readthedocs.org/en/latest/)
<a name="WG6rp"></a>
### 33 Haskell

1. [Real World Haskell 中文版](http://rwh.readthedocs.org/en/latest/)
<a name="tqO9X"></a>
### 34 Scala

1. [Scala课堂](http://twitter.github.io/scala_school/zh_cn/index.html) (Twitter的Scala中文教程)
